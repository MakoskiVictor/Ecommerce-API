            ...
            <section className={s.containerMain}>
                ...
                <section className={s.MainContainerInfo}>
                    ...
                    <div className={s.buttonContain}>
                        {isAdmin === false ? <button className={s.promote} onClick={handleAdmin} name="adminButton">PROMOTE TO ADMIN</button> : <button className={s.remove} onClick={handleAdmin} name="adminButton">REMOVE ADMIN</button>}
